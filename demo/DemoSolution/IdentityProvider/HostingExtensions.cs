...
using IdentityProvider.Pages.Admin.ApiScopes;
using IdentityProvider.Pages.Admin.Clients;
using IdentityProvider.Pages.Admin.IdentityScopes;
...
internal static class HostingExtensions
{
    ...
    public static WebApplication ConfigureServices(this WebApplicationBuilder builder)
    {
        ...
        // this adds the necessary config for the simple admin/config pages
        {
            ...
            builder.Services.AddTransient<IdentityProvider.Pages.Portal.ClientRepository>();
